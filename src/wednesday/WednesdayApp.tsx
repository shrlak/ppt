...
export default function WednesdayApp() {
  ...
  return (
    <AppShell service="wednesday" steps={STEPS} activeStep={step} onStepSelect={setStep} testIdPrefix="wednesday">
      <div className="app-body">
        <main id="main-content">
          ...
          >
            ...
            <StepNav steps={STEPS} index={0} onMove={setStep} testIdPrefix="wednesday" />
          </section>
          ...
          >
            ...
            <StepNav steps={STEPS} index={1} onMove={setStep} testIdPrefix="wednesday" />
          </section>
          ...
          >
            ...
            <StepNav steps={STEPS} index={2} onMove={setStep} testIdPrefix="wednesday" />
          </section>
        </main>
      </div>
