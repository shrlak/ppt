...
export const BASE_PROMPT_LINES: string[] = [
  ...
  '  파트 라벨은 악보에 인쇄된 표시(1절, 후렴, Verse, Chorus, Bridge, 볼드체 구분선 등)를 근거로',
  '  정하세요. 아무 표시도 없으면 곡의 구조로 판단합니다: 멜로디가 반복되며 가사만 바뀌는 묶음은',
  ...
  '악보의 띄어쓰기는 음표 간격을 따른 것이라 실제 띄어쓰기와 다릅니다. 가사는 한국어',
  '맞춤법에 맞는 띄어쓰기와 표기로 적으세요 (예: "주님 을 찬양 해" → "주님을 찬양해").',
  '바로잡는 것은 표기(띄어쓰기·맞춤법)뿐입니다. 단어와 내용은 악보에 적힌 그대로 두세요.',
